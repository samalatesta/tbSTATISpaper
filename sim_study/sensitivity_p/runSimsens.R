...
setwd("/usr3/graduate/samalate/projectnb/cbs/samalate/tbSTATISpaper/sim_study/sensitivity")
...
#save results 
saveRDS(sim1[[1]], paste0("./sim_results/sim_seq_sens_",M,"_", p, "_", N,"_", iTask, ".rds"))
saveRDS(sim1[[2]], paste0("./sim_results/sim_data_sens_",M,"_", p, "_", N,"_", iTask, ".rds"))
