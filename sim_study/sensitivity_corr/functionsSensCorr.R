...
## Script purpose: This program contains all functions to run TB-STATIS and generate data for a simulation study designed to test 
## the sensitivity of TB-STATIS to the correlation between clinical measures. make_data function is modified while all other functions
## remain unchanged. 
## Date: 07/28/2025
